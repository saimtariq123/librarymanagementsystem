        ...
        while (flag) {
            ...
            switch (option) {
                ...
                for(int i = 0; i < title1.length(); i++) {
                    if (!(title1.charAt(i) >= 'A' && title1.charAt(i) <= 'Z') && !(title1.charAt(i) >= 'a' && title1.charAt(i) <= 'z')) {
                        allAlphabetic = false;
                        break;
                    }
                }
                ...
                boolean isAlphabetic = titleToReturn.matches("[a-zA-Z]+");
                if (!isAlphabetic) {
                ...
                String titleToBorrow = input.next();
                
                // Check if the title consists of alphabetic characters
                boolean isAlphabetic1 = titleToBorrow.matches("[a-zA-Z]+");
                if (!isAlphabetic1) {
                    System.out.println("Please enter a title with alphabetic characters only.");
                    break; // Exit the switch statement
                }
